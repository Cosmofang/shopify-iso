...
- 错误在商家 blur/提交等交互后出现，并保持到修正完成。
- 字段错误显示在对应字段附近；页面级错误用持久 Banner。
- 必填/格式/占位说明写清楚。
...
## BFS 注意
- **4.2.4**：错误必须持久、红色、就近、可行动，并在交互后出现。逐个校验分支都要验到。
